...
for fileName in fileList:
    ...
    if sheetName[1] == 'xlsx' and '研制任务书需求分析调查表' in sheetName[0]:
        ...
        ws1 = wb.create_sheet()
        ws1.title = u'功能匹配度'
        ws1.cell(row=1,column=1).value='需求类别'
        ws1.cell(row=1,column=2).value='客户需求'
        
        ws2 = wb.create_sheet()
        ws2.title = u'开发难度'
        ws2.cell(row=1,column=1).value='需求类别'
        ws2.cell(row=1,column=2).value='客户需求'
        ...
        ws4 = wb.create_sheet()
        ws4.title = u'最显著差异'
        ws4.cell(row=1,column=1).value='需求类别'
        ws4.cell(row=1,column=2).value='客户需求'
        
        for row_line in range(2,curSheet_delphi.max_row+1):     #skip the first line
            ws1.cell(row=1,column=1).value = curSheet_delphi.cell(row= row_line, column=1).value
            ws1.cell(row=1,column=2).value = curSheet_delphi.cell(row= row_line, column=2).value
            ws1.cell(row=1,column=3).value = curSheet_delphi.cell(row= row_line, column=3).value
                
            ws2.cell(row=1,column=1).value = curSheet_delphi.cell(row= row_line, column=1).value
            ws2.cell(row=1,column=2).value = curSheet_delphi.cell(row= row_line, column=2).value
            ws2.cell(row=1,column=3).value = curSheet_delphi.cell(row= row_line, column=2).value
                
            ws3.cell(row=1,column=1).value = curSheet_delphi.cell(row= row_line, column=1).value
            ws3.cell(row=1,column=2).value = curSheet_delphi.cell(row= row_line, column=2).value
            ws3.cell(row=1,column=3).value = curSheet_delphi.cell(row= row_line, column=2).value
                
            ws4.cell(row=1,column=1).value = curSheet_delphi.cell(row= row_line, column=1).value
            ws4.cell(row=1,column=2).value = curSheet_delphi.cell(row= row_line, column=2).value
            ws4.cell(row=1,column=3).value = curSheet_delphi.cell(row= row_line, column=2).value
                
            if curSheet_delphi.cell(row= row_line, column=1).value == curSheet_delphi.cell(row= row_line+1, column=1).value： 
        ...
        #for curSheet in allSheetNames:
         #   if '研制任务书需求分析表' in curSheet:
         #       curSheet_delphi=tableOpen.get_sheet_by_name(curSheet)
                #print(curSheet_delphi.cell(row= 1, column=5).value,curSheet_delphi.max_row)    
         #       
                #for row_line in range(2,curSheet_delphi.max_row+1):     #skip the first line
                #table_cnt=table_cnt
                #break
